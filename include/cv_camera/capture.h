...
class Capture
{
   public:
     ...
     */
    Capture(rclcpp::Node::SharedPtr node, const std::string& topic_name, uint32_t buffer_size,
     ...
     */
    inline const sensor_msgs::msg::Image::SharedPtr getImageMsgPtr() const { return bridge_.toImageMsg(); }
